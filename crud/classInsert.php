...
class Insert extends Connection
{
    ...
    public function Entrada($cpf, $data, $entrada, $name, $placa)
    {

        $conn = self::connect();
        $insert = $conn->prepare("INSERT INTO carr (cpf, data, entrada, name, placa) VALUES  (:cpf, :data, :entrada, :name, :placa)");
